...
class Game():
    ...
    def game_over(self):
        ...
        while True:
            ...
            snake.check_for_collapse(game.game_over, game.screen_width, game.screen_height)
...
class Food():
    def __init__(self, food_color, screen_width, screen_height):
        ...
        self.food_size_x = 25
        self.food_size_y = 25
        self.food_pos = [random.randrange(1, screen_width//25)*25, random.randrange(1, screen_height//25)*25]

    def draw_food(self, play_surface):
        '''play_surface.blit(pygame.image.load('apple.png'), (self.food_pos[0], self.food_pos[1]))'''
        pygame.draw.rect(
            play_surface, self.food_color, pygame.Rect(self.food_pos[0], self.food_pos[1], self.food_size_x, self.food_size_y))
